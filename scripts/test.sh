...
#   1. Unit tests for render.mjs (escapeHtml/buildLangs/buildKeypoints/renderCard)
#   2. JSON data validation for site/assets/data/*.json
...
echo "============================================================"
echo " 1/3  Unit tests — test/render.test.mjs"
echo "============================================================"
