#!/bin/bash
# =========================================================
# sync-to-production.sh — INTERACTIVE-ONLY PRODUCTION DEPLOYMENT
# =========================================================
#
# SECURITY DESIGN: This script deliberately DOES NOT accept CLI arguments
# or environment-based automation. See docs/SYNC-TO-PRODUCTION-DESIGN.md
# for detailed rationale. tl;dr: The stdin confirmations ARE the security
# feature. They ensure a human reviews every production sync.
#
